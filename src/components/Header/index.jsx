...
const Header = () => {
	...
	return (
		<header
			id="header"
			className="absolute top-0 left-0 w-full z-50 px-4 sm:px-8 lg:px-16 xl:px-40 2xl:px-64 text-gray-50 dark:text-gray-50"
		>
			<div className="hidden lg:flex justify-between items-center border-b text-sm py-3">
				<div className="">
					<ul className="flex">
						<li>
							<div className="flex items-center">
								...
								<span className="ml-2">Philadelphia, PA</span>
							</div>
						</li>
						<li className="ml-6">
							<div className="flex items-center">
								...
								<span className="ml-2">(267) 343-4552</span>
							</div>
						</li>
					</ul>
				</div>
