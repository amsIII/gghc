			...
			<div class="flex flex-col lg:flex-row">
				<div class="w-full md:w-1/2 lg:w-2/6 lg:mx-4 lg:pr-8">
					...
					>
						...
						<div class="w-full">
							<label
								class="block uppercase tracking-wide text-gray-400 text-xs font-semibold mb-2"
								for="grid-last-name"
							>
							...
							<div class="relative">
								...
								<button
									type="submit"
									class="bg-gradient-to-r from-blue-500 to-green-400 text-white hover:from-green-400 hover:to-blue-500 px-4 py-2 text-sm font-bold rounded absolute top-0 right-0 my-2 mr-2"
								>
									Subscribe
								</button>
								<span
									id="success"
									class="hidden mt-2 px-4 py-2 font-medium border rounded-sm border-green-500 bg-green-100 text-green-600"
								>
									Thanks! We'll be in touch soon.
								</span>
								<span
									id="error"
									class="hidden mt-2 px-4 py-2 font-medium border rounded-sm border-red-500 bg-red-100 text-red-600"
								>
					...
					<ul class="mt-4">
						<li>
							...
							>
								...
								<span class="ml-3">3 Abbey Rd, London, United Kingdom</span>
							</a>
						</li>
						<li class="mt-4">
							<a
						...
						<li class="mt-4">
							...
							>
								...
								<span class="ml-3">(+27) 81 343 4552</span>
							</a>
						</li>
						<li class="mt-4">
							<a
							...
							>
								...
								<span class="ml-3">agency@mail.com</span>
							</a>
						</li>
					</ul>
				</div>
				...
				<div class="w-full md:w-1/8 lg:w-1/6 mt-20 lg:mt-0 lg:mx-4">
					...
					<p class="text-sm text-gray-400 mt-12">
						© 2021 Dentist Marketing<span class="md:hidden">, </span>
